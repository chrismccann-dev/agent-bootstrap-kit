...
- **Grilling / interpretive**: the decision is *not* yet made. The human's input is the important
  signal here. Default to "ask, don't ship." Do not let an execution-shaped habit push
